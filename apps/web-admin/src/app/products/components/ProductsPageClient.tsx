          ...
          >
            <div className="flex w-max min-w-full items-center gap-2 pb-0.5">
              <button
                ...
                className={`shrink-0 rounded-full border px-4 py-1.5 text-sm font-semibold transition ${categoryFilter === ""
              ...
              {categories.map((c) => (
                <button
                  ...
                  className={`shrink-0 rounded-full border px-4 py-1.5 text-sm font-semibold transition ${categoryFilter === c.id
                    ? "border-[#1a3c34] bg-[#1a3c34] text-white shadow-sm"
                    : "border-black/10 bg-white text-foreground/65 hover:border-[#1a3c34]/30 hover:text-[#1a3c34]"
                    }`}
                >
