  ...
  return (
    <motion.div className="h-full" {...animProps}>
      <Link
        ...
        className="group flex h-full flex-col overflow-hidden rounded-xl border border-black/[0.06] bg-white shadow-[0_2px_12px_-4px_rgba(0,0,0,0.07)] transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_8px_30px_-8px_rgba(0,0,0,0.14)]"
      >
        {/* Image */}
        <div
        ...
        >
          ...
          <div className="absolute inset-x-0 bottom-3 flex translate-y-2 justify-center opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100">
            <span className="flex items-center gap-1.5 rounded-full bg-white/95 px-4 py-1.5 text-[11px] font-semibold text-[#1a3c34] shadow-lg backdrop-blur-sm">
              <ShoppingBag className="size-3.5" />
              Xem sản phẩm
            </span>
          </div>

          {/* Mobile quick-view badge — always visible, hidden on desktop */}
        ...
        <div className="flex flex-1 flex-col px-3 pb-3.5 pt-2.5 sm:px-4 sm:pb-4 sm:pt-3">
          ...
          <h3 className="mt-1 flex-1 line-clamp-2 text-sm font-semibold leading-snug text-foreground sm:text-[15px]">
            {product.name}
          </h3>
